...
fn git_pull(
    local_remote: PathBuf,
    remote_name: &str,
    remote_branch: &str,
) -> Result<(), git2::Error> {
    let repo = Repository::open(local_remote)?;
