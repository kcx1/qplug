    ...
    Command::new("qplug")
        ...
        .subcommand(Command::new("sync")
            ...
            .arg(Arg::new("config")
                ...
                .value_parser(clap::value_parser!(PathBuf))
                .action(ArgAction::Set)
                .default_value("core.json")
            )
            .arg(Arg::new("is_watched")
                .help("If this is set to true, the script will be watched for changes, and will then sync the changes to the core.")
                .action(ArgAction::SetTrue)
                .default_value("false")
                .short('w')
                .long("watch")
